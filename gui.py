...
if platform.system() == "Windows":
    ...
    try:
        ...
        print("SetProcessDpiAwareness is not available on this platform.")
    except Exception as e:
        print(f"An error occurred while setting DPI awareness: {e}")
else:
    print("DPI awareness setting is not required or applicable on macOS.")
...
def open_popup_input(text):
    ...
    popup_btn = ttk.Button(popup, text="OK", command=set_user_arg)
    popup_btn.pack(pady=10)

    popup.bind('<Return>', lambda e: set_user_arg())
